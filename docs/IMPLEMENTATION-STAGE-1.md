...
- [x] Stable command/event model for editor, build, debug and Git actions.
- [x] AI assistant session boundary and approval states.
...
- [x] Headless integration tests before UI implementation.
